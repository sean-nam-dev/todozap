package com.devflowteam.feature_home.ui.overdue
...
import com.devflowteam.feature_home.databinding.FragmentOverdueBinding
                ...
                viewModel.list.collect { list ->
                    binding.recyclerView.apply {
                        ...
                        adapter = StaggeredAdapter(
                            items = list.filter { it.status == Status.OVERDUE },
                            onItemClickAction = { currentId ->
                                viewModel.onHomeUIAction(HomeUIAction.PassID(currentId, false))
                            }
                        )
                        addItemDecoration(
